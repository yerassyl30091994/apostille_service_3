...
.keyframesEffect ( @name ) {
  @-webkit-keyframes @name {.mixi-frames;}
  @-moz-keyframes @name {.mixi-frames;}
  @-ms-keyframes @name {.mixi-frames;}
  @-o-keyframes @name {.mixi-frames;}
  @keyframes @name {.mixi-frames;}
}
